...
<div>
	<div class="container">
		<div class="row">
			...
			<div class="col-sm">
				<form action="/advance-java/employee/add/noorain">
...
<div>
	<form action="/advance-java/employee/search/noorain" class="form-inline">
		<div class="form-group mx-sm-3 mb-2 container">
			...
			if(!employeeList.isEmpty()){
				for(Employee employee : employeeList){
					%>
						<tr>
							<td>
								<a href="/advance-java/employee/detail/noorain?empId=<%= employee.getId() %>">
									<%= employee.getName() %>
								</a>
							</td>
							...
							<td>
								<div class="row">
									<div class="col-sm-3">
										<a href="/advance-java/employee/delete/noorain?empId=<%= employee.getId() %>" 
											class="btn btn-danger">Delete</a>
									</div>
									<div class="col-sm-3">
										<a href="/advance-java/employee/update/noorain?empId=<%= employee.getId() %>"
