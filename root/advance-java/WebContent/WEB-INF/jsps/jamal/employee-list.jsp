...
<div>
	<div class="container">
		<div class="row">
			...
			<div class="col-sm">
				<form action="/advance-java/employee/add/jamal">
...
<div>
	<form action="/advance-java/employee/search/jamal" class="form-inline">
		<div class="form-group mx-sm-3 mb-2 container">
			...
			if(!employeeList.isEmpty()){
				for(Employee employee : employeeList){
					%>
						<tr>
							<td>
								<a href="/advance-java/user/detail/jamal?userId=<%= employee.getId() %>">
									<%= employee.getName() %>
								</a>
							</td>
							...
							<td><%= employee.getJoined_date() %></td>
							<td><%= employee.getRelease_date() %></td>
							<td><%= employee.getNotice_period() %></td>
							<td><%= employee.getDob() %></td>
						
							<td>
								<div class="row">
									<div class="col-sm-3">
										<a href="/advance-java/employee/delete/jamal?userId=<%= employee.getId() %>" 
											class="btn btn-danger">Delete</a>
									</div>
									<div class="col-sm-3">
										<a href="/advance-java/employee/update/jamal?userId=<%= employee.getId() %>"
