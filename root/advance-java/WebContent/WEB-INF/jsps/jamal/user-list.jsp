<%@page import="org.ecom.jamal.model.User"%>
...
<div>
	<div class="container">
		<div class="row">
			...
			<div class="col-sm">
				<form action="/advance-java/user/add/jamal">
...
<div>
	<form action="/advance-java/user/search/jamal" class="form-inline">
		<div class="form-group mx-sm-3 mb-2 container">
			...
			if(!userList.isEmpty()){
				for(User user : userList){
					%>
						<tr>
							<td>
								<a href="/advance-java/user/detail/jamal?userId=<%= user.getId() %>">
									<%= user.getFirstName() %>
								</a>
							</td>
							<td><%= user.getEmail() %></td>
							...
							<td>
								<div class="row">
									<div class="col-sm-3">
										<a href="/advance-java/user/delete/jamal?userId=<%= user.getId() %>" 
											class="btn btn-danger">Delete</a>
									</div>
									<div class="col-sm-3">
										<a href="/advance-java/user/update/jamal?userId=<%= user.getId() %>"
