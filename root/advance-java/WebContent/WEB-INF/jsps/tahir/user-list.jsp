<%@page import="org.ecom.tahir.model.User"%>
...
<div>
	<div class="container">
		<div class="row">
			...
			<div class="col-sm">
				<form action="/advance-java/user/add/tahir">
...
<div>
	<form action="/advance-java/user/search/tahir" class="form-inline">
		<div class="form-group mx-sm-3 mb-2 container">
			...
			if(!userList.isEmpty()){
				for(User user : userList){
					%>
						<tr>
							<td>
								<a href="/advance-java/user/detail/tahir?userId=<%= user.getId() %>">
									<%= user.getFirstName() %>
								</a>
							</td>
							<td><%= user.getEmail() %></td>
							...
							<td>
								<div class="row">
									<div class="col-sm-3">
										<a href="/advance-java/user/delete/tahir?userId=<%= user.getId() %>" 
											class="btn btn-danger">Delete</a>
									</div>
									<div class="col-sm-3">
										<a href="/advance-java/user/update/tahir?userId=<%= user.getId() %>"
