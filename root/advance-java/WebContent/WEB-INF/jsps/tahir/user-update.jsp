...
<div>
	<h2>
		...
		<a class="btn btn-link mx-3" href="/advance-java/user/list/tahir" role="button">Back</a>
	</h2>
</div>
<%
...
<form action="/advance-java/user/update/tahir" method="post" class="container mb-5">
  ...
  <div class="form-group">
	...
	<div class="form-group">
  	...
  	<a class="btn btn-dark mx-3" href="/advance-java/user/list/tahir" role="button">Cancel</a>
</form> 
